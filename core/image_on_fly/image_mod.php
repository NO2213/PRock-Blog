...
class timthumb {
	...
	public function __construct(){
		...
		/*
		// Secret key to decrypt with
		$key = IMAGE_ON_FLY_SECRET_KEY;  // 8-32 characters without spaces
		
		// DeCrypt back
		$this->src = @convert(urldecode($this->param('src')), $key);
		*/
	    $this->src = ($this->param('de') == 1) ? base64_decode( urldecode($this->param('src') ) ) : urldecode($this->param('src'));
...
//header('Location: '.WEBSITE_URL); // redirect added by jino
//exit(0);
